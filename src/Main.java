public class Main {
    ...
    public static void main(String[] args) {
        ...
        thisGraph1.addEdge(7, 0, 28);
        thisGraph1.addEdge(10, 0, 13);
        thisGraph1.addEdge(15, 0, 25);
        thisGraph1.addEdge(6, 1, 60);
        thisGraph1.addEdge(5, 1, 24);
        thisGraph1.addEdge(8, 1, 25);
        thisGraph1.addEdge(11, 1, 19);
        thisGraph1.addEdge(12, 1, 47);
        thisGraph1.addEdge(13, 1, 48);
        thisGraph1.addEdge(14, 1, 34);
        thisGraph1.addEdge(15, 1, 40);
        thisGraph1.addEdge(3, 2, 34);
        thisGraph1.addEdge(4, 2, 44);
        thisGraph1.addEdge(6, 2, 66);
        thisGraph1.addEdge(11, 2, 36);
        thisGraph1.addEdge(12, 2, 32);
        thisGraph1.addEdge(13, 2, 46);
        thisGraph1.addEdge(14, 2, 34);
        thisGraph1.addEdge(6, 3, 94);
        thisGraph1.addEdge(5, 3, 58);
        thisGraph1.addEdge(11, 3, 56);
        thisGraph1.addEdge(12, 3,33 );
        thisGraph1.addEdge(13, 3, 74);
        thisGraph1.addEdge(14, 3, 63);
        thisGraph1.addEdge(11, 4, 62);
        thisGraph1.addEdge(12, 4, 70);
        thisGraph1.addEdge(13, 4, 39);
        thisGraph1.addEdge(14, 4, 51);
        thisGraph1.addEdge(8, 6, 45);
        thisGraph1.addEdge(13, 6, 20);
        thisGraph1.addEdge(8, 5, 45);
        thisGraph1.addEdge(11, 5, 28);
        thisGraph1.addEdge(12, 5, 25);
        thisGraph1.addEdge(15, 5, 60);
        thisGraph1.addEdge(9, 7, 27);
        thisGraph1.addEdge(10, 7, 26);
        thisGraph1.addEdge(12, 8, 57);
        thisGraph1.addEdge(11, 8, 26);
        thisGraph1.addEdge(13, 8, 37);
        thisGraph1.addEdge(14, 8, 32);
        thisGraph1.addEdge(15, 8, 28);
        thisGraph1.addEdge(12, 11, 31);
        thisGraph1.addEdge(14, 11, 15);
        thisGraph1.addEdge(15, 11, 58);
        thisGraph1.addEdge(14, 13, 14);
